...
<?php echo $rec['selectedclass']; ?>
 ...
 <table border="10" cellpadding="0" style="border:thick;"  bordercolor="#000000" width="1000" align="center">
<tr align="center" style="background-color:#09a9fa; font-size:16px; color:#fff;">
<th>S. No.</th> <th>Name *</th> <th>Age </th><th>Gender</th><th>Berth Preference</th><th>Seat No</th><th>Cancel</th>
</tr>
<tr>
    <td>1</td>
    ...
    <td><a href="cancel.php?seat1=<?php echo $rec['seat1']; ?>">Cancel Ticket</a> </td>
</tr>
<tr>
    <td>2</td>
    ...
    <td><a href="cancel.php?seat2=<?php echo $rec['seat2']; ?>">Cancel Ticket</a> </td>
</tr>
<tr>
    <td>3</td>
    ...
    <td><a href="cancel.php?seat3=<?php echo $rec['seat3']; ?>">Cancel Ticket</a> </td>
</tr>
<tr>
    <td>4</td>
    ...
    <td><a href="cancel.php?seat4=<?php echo $rec['seat4']; ?>">Cancel Ticket</a> </td>
</tr>
<tr>
    <td>5</td>
    ...
    <td><a href="cancel.php?seat5=<?php echo $rec['seat5']; ?>">Cancel Ticket</a> </td>
</tr>
<tr>
    <td>6</td>
    ...
    <td><a href="cancel.php?seat6=<?php echo $rec['seat6']; ?>">Cancel Ticket</a> </td>
</tr>
<tr>
