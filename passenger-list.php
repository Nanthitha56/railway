...
<th>Date</th> <th>Train No</th> <th>Train Name</th><th>From</th><th>Departure</th><th>To</th><th>Arrival</th><th>Fare</th><th>Passenger</th><th>Class</th><th>PNR No</th><th>PNR Status</th> 
</tr>
...
<td> <?php echo $rec['totalprice']; ?> </td>
<td> <?php echo $rec['totalpassenger']; ?> </td>
<td> <?php echo $rec['selectedclass']; ?> </td>
<td> <?php echo $rec['pnrno']; ?> </td>
<td> <?php echo $rec['pnrstatus']; ?> </td>
</tr>
<?php } ?>
</table>
							</div>
